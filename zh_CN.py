...
data = {
    ...
    "This plugin integrates some of the Pepperoni Joe's plugins and is developed based on MACHIN3TOOLS.": '该插件集成了部分辣椒小组的插件，并以MACHIN3TOOLS为基础进行开发。',
    ...
    "Font Size": '字体大小',
    "Highlight Operators from M4N1 addons": '突出显示来自 M4N1 插件的操作符',
    ...
    "M4N1: Load previous file": 'M4N1：加载上一个文件',
    "M4N1: Load next file": 'M4N1：加载下一个文件',
    ...
    "M4N1: Purge Orphans": 'M4N1：清理孤立物',
    "Clean out .blend file!": '清理 .blend 文件！',
    "M4N1: Reload Linked Liraries": 'M4N1：重新加载链接的库',
    "M4N1: Screen Cast": 'M4N1：屏幕录制',
    ...
    "M4N1: Bake Group Gizmo Size":"M4N1: 烘焙组控件大小",
    "M4N1: Retrieve Group Pose": "M4N1: 检索组姿势",
    "M4N1: Sort Group Pose":"M4N1: 排序组姿势",
    "Move Selected Group Pose {}": '移动所选组姿势{}',
    "M4N1: Remove Group Pose": "M4N1: 移除组姿势",
    ...
    "Hold down ATL, CTRL or neither, not both!": '聚焦',
    "Hold down ATL, CTRL or neither, not both!": '按住ALT键、CTRL键或者都不按，不要同时按下两个键！',
    ...
    "M4N1: Surface Draw Mode": 'M4N1：表面绘制模式',
    ...
    "Toggle Object Outlines": '切换物体轮廓线',
    ...
    "M4N1: Switch Shading": 'M4N1：切换着色',
    "M4N1: Rotate Studiolight": 'M4N1: 旋转灯光',
    "Rotate Studio Light by {} degrees\nALT: Rotate visible lights too": '旋转 {} 度的工作室灯光\nALT: 也旋转可见灯光',
    "M4N1: Add World": '添加世界环境',
    "M4N1: Adjust Bevel Radius": '调整倒角半径',
    "\n{} {} Bevel Radius": '\n{} {} 倒角半径',
    "\nSHIFT: {} {} Bevel Radius": '\nSHIFT: {} {} 倒角半径',
    ...
    "M4N1: Colorize Objects from Groups": 'M4N1：从组着色对象',
    ...
    "Use Shadows when in Flat Lighting": '使用平面照明时应用阴影',
    ...
    "M4N1: Next Cam": '下一相机',
    "M4N1: Toggle Camera Perspective/Ortho": '切换相机为透视/正交投影',
    "Toggle Active Scene Camera Perspective/Ortho": '切换当前场景相机为透视/正交投影',
    "M4N1: Toggle View Perspective/Ortho": '切换视图为透视/正交投影',
    "Toggle Viewport Perspective/Ortho": '切换视口为透视/正交投影',
    "M4N1: Toggle Orbit Method": '切换轨道方式',
    ...
    'Check M4N1tools prefs.':'检查 M4N1tools 首选项。',
    '(X) Un-Group':'（X）取消分组',
    ...
    'M4N1: Toggle Outliner Children':'M4N1:切换大纲子项',
    'M4N1: Toggle Outliner Group Mode':'M4N1:切换大纲组模式',
    'M4N1: Collapse Outliner':'M4N1: 折叠大纲视图',
    'M4N1: Expand Outliner':'M4N1: 展开大纲视图',
    'Pose: {}{}':'姿势: {}{}',
    ' (remove)':' (移除)',
    'Preview Alpha: {}':'预览透明: {}',
    'M4N1: Transform Group':'M4N1: 变换图层组',
    'Rotate Group':'旋转群组',
    ' around ':' 围绕 ',
    'Angle: ':'角度: ',
    'Snapping':'吸附',
    'Pose: ':'姿势: ',
    'Alpha: ':'透明度: ',
    'M4N1: Bake Group Gizmo Size':'M4N1: 将图层组的转换工具大小烘焙',
    "Set Global Size to 1, and compensate each Group's Size accordingly.":"将全局尺寸设置为 1,并相应地调整每个组的尺寸。",
    'M4N1: Setup Group Gizmos':'M4N1: 设置组小部件',
    'Setup Group Gizmos':'设置组小部件',
    'show_group_{}_rotation':'显示组 {} 的旋转',
    ' Global: {}':' 全局: {}',
    'Lock Rotational Axes ':'锁定旋转轴',
    '(those without Gizmos)':'(那些没有小部件的)',
    'M4N1: Set Group Pose':'M4N1: 设置组姿态',
    'M4N1: Update Group Pose':'M4N1: 更新组姿态',
    'Update active Pose from current Group Empty Rotation':'从当前组空对象的旋转更新活动姿态',
    'Update Up':'更新朝上',
    ...
    'Remove all related Batch Poses in the Group Hierarchy':'aaa',
    'Edit Mode':'编辑模式',
    'Horizontal':'水平',
    'Vertical':'垂直',
    'Shortest Path':'最短路径',
    ...
    'M4N1: Smart Vert':'M4N1: 智能顶点',
    'M4N1: Smart Edge':'M4N1: 智能边',
    'M4N1: Smart Face':'M4N1: 智能面',
    'M4N1: Clean Up':'M4N1: 清理',
    'M4N1: Clipping Toggle':'M4N1: 裁切变换',
    'M4N1: Focus':'M4N1: 聚焦',
    "M4N1: Mirror":'M4N1: 镜像',
    'M4N1: Call M4N1tools Pie':'M4N1: 呼出菜单',
    "M4N1: Open in System's filebrowser":'M4N1: 在系统文件浏览器中打开',
    'M4N1: Toggle Filebrowser':'M4N1: 切换文件浏览器',
    'M4N1: Cycle Thumbnail Size':'M4N1: 循环缩略图大小',
    'M4N1: Group':'M4N1: 打组',
    'M4N1: Select Group':'M4N1: 选择组',
    'M4N1: Transform Edge Constrained':'M4N1: 受约束的边缘变换',
    'M4N1: Duplicate Nodes':'M4N1: 复制节点',
    'Modes':'模式',
    'UV Align':'uv对齐',
    'Inception':'初始',
    'LegacyPose':'初始姿态',
    'M4N1: Align':'M4N1: 对齐',
    'M4N1: Align Relative':'M4N1: 相对对齐',
    'M4N1: Apply Transformations':'M4N1: 应用变换',
    'M4N1: Create Assembly Asset':'M4N1: 创建装配资产',
    'Create Assembly Asset from the selected Objects':'从选定的对象创建装配资产',
    'M4N1: Assetbrowser Bookmark':'M4N1: 资产浏览器书签',
    'M4N1: Customize':'M4N1: 自定义',
    'Customize various Blender preferences, settings and keymaps.':'自定义各种Blender首选项、设置和快捷键。',
    'M4N1: Restore Keymaps':'M4N1: 恢复快捷键',
    'M4N1: Punch It':'M4N1: 打孔',
    'Manifold Extruding that works':'有效的多曲面挤出',
    'M4N1: Cursor Spin':'M4N1: 光标旋转',
    'M4N1: Un-Group':'M4N1: 取消分组',
    'M4N1: Groupify':'M4N1: 分组',
    'M4N1: Material Picker':'M4N1: 材质取色器',
    'Pick a Material from the 3D View\nALT: Assign it to the Selection too':'从3D视图中选取材质\nALT: 同时将其分配给选择',
    'M4N1: Mesh Cut':'M4N1: 网格切割',
    "Cut a Mesh Object, using another Object.\nALT: Flatten Target Object's Modifier Stack\nSHIFT: Mark Seams":"使用另一个物体切割网格物体。\nALT: 展平目标物体的修改器堆栈\nSHIFT: 标记边缘",
    'M4N1: Quadsphere':'M4N1: 四边形球体',
    'Creates a Quadsphere':'创建一个四边形球体',
    'M4N1: Toggle 3D View Region':'M4N1: 切换3D视图区域',
    'M4N1: Toggle Asset Browser Region':'M4N1: 切换资产浏览器区域',
    'Toggle Asset Browser Region based on Mouse Position':'根据鼠标位置切换资产浏览器区域',
    'M4N1: Toggle Toolbar or Sidebar (Any Region)':'M4N1: 切换工具栏或侧边栏(任何区域)',
    'Toggle Toolbar or Sidebar (Any Region)':'切换工具栏或侧边栏(任何区域)',
    'M4N1: Area Dumper':'M4N1: 区域dump器',
    'M4N1: Render':'M4N1: 渲染',
    ...
    'M4N1: Smart Drive':'M4N1: 智能驱动',
    'M4N1: Switch Driver Values':'M4N1: 切换驱动器值',
    'M4N1: set_driver_value':'M4N1: 设置驱动器值',
    'M4N1: Toggle Smooth':'M4N1: 切换平滑',
    'Toggle Smothing for Korean Bevel and SubD Objects':'切换韩式斜角和细分网格物体的平滑设置。',
    'M4N1: Surface Slide':'M4N1: 表面滑动',
    'Start Surface Sliding: modifify the topology while keeping the inital form intact':'开始表面滑动:在保持初始形状完整的情况下修改拓扑结构。',
    'M4N1: Finish Surface Slide':'M4N1: 完成表面滑动',
    'Stop Surface Sliding':'停止表面滑动',
    'M4N1: Add Thread':'M4N1: 添加螺纹',
    'M4N1: Prepare Unity Export':'M4N1: 准备Unity导出',
    'M4N1: Restore Unity Export':'M4N1: 恢复Unity导出',
    'Restore Pre-Export Object Transformations, Meshes and Modifiers':'恢复导出前的物体变换、网格和修改器设置。',
    'M4N1: Draw Group Rest Pose':'M4N1: 绘制组静止姿态',
    'Reverse the Motion':'反转动作',
    'Time (s)':'时间(秒)',
    'M4N1: Align (Edit Mesh)':'M4N1: 对齐(编辑网格)',
    'M4N1: Align Object to Edge':'M4N1: 将物体对齐到边缘',
    'M4N1: Center (Edit Mesh)':'M4N1: 居中(编辑网格)',
    ...
    'M4N1: Align Object to Vert':'M4N1: 将物体对齐到顶点',
    'Align one or more objects to vertice in active object':'将一个或多个物体对齐到活动物体的顶点',
    'M4N1: Straighten':'M4N1: 拉直',
    'M4N1: Create Collection':'M4N1: 创建集合',
    'M4N1: Remove from Collection':'M4N1: 从集合中移除',
    'M4N1: Purge Collections':'M4N1: 清除集合',
    'M4N1: (De)Select Collection':'M4N1: (取消)选择集合',
    'M4N1: Cursor to Origin':'M4N1: 光标移动到原点',
    'M4N1: Cursor to Selected':'M4N1: 光标移动到所选位置',
    'M4N1: Selected To Cursor':'M4N1: 所选物体移动到光标位置',
    'M4N1: Draw Label':'M4N1: 绘制标签',
    'Text to draw the HUD':'绘制HUD的文本',
    'Text Size':'文本大小',
    'Screen Coordinates':'屏幕坐标',
    'Move Up or Down':'上下移动',
    'M4N1: ShrinkWrap Grease Pencil':'M4N1: 收缩铺路铅笔',
    'Shrinkwrap current Grease Pencil Layer to closest mesh surface based on Surface Offset value':'根据表面偏移值,将当前铅笔图层收缩到最近的网格表面',
    'M4N1: Get M4N1tools Support':'M4N1: 获取M4N1工具支持',
    'Generate Log Files and Instructions for a Support Request.':'生成日志文件并提供支持请求的说明。',
    'M4N1: Image Mode':'M4N1: 图像模式',
    'M4N1: UV Mode':'M4N1: UV模式',
    'M4N1: Open Library Blend':'M4N1: 打开库Blend文件',
    ...
    'M4N1: Origin to Active':'M4N1: 原点移动到活动物体',
    'M4N1: Origin to Cursor':'M4N1: 原点移动到光标位置',
    'M4N1: Origin to Bottom Bounds':'M4N1: 原点移动到物体底部边界',
    'Evaluated Object Bounds':'计算物体边界',
    'M4N1: Save As':'M4N1: 另存为',
    'Save as Copy':'另存为副本',
    'Save as Asset':'另存为资产',
    ...
    'Collection':'集合',
    'Based on the M3 tool, add more features to make Blender more user-friendly':'基于M3工具,添加更多功能来使Blender更加用户友好',
